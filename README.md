...
A sophisticated performance engineering project that demonstrates building and optimizing a React-based news aggregator application. The project intentionally starts with performance anti-patterns, then systematically optimizes using professional profiling tools and best practices.

## 📋 Project Overview

This project is divided into two main phases:

1. **Phase 1: Building the "Slow" Version** - Demonstrates common performance anti-patterns
2. **Phase 2: Optimization** - Systematically applies performance improvements

The application fetches the top 500 stories from HackerNews and displays them with filtering and sorting capabilities. It serves as a practical exercise in modern web performance optimization.

## 🎯 Key Features

- **Real-time Article Fetching**: Pulls top 500 stories from HackerNews API
- **Search Functionality**: Filter articles by title with real-time updates
- **Sorting**: Sort articles by score
- **Responsive Design**: Works seamlessly on desktop and mobile
- **Performance Monitoring**: Includes Lighthouse integration and bundle analysis
...
#### Development Mode (SLOW VERSION)

To see the deliberately unoptimized version:
...
#### Development Mode (OPTIMIZED VERSION)

To see the final optimized version:
